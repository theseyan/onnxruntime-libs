function(bundle_static_library bundled_target_name)
  ...
  endforeach()
  file(GENERATE OUTPUT static_libs.txt INPUT ${CMAKE_CURRENT_BINARY_DIR}/static_libs.txt.in)
  ...
  elseif(APPLE)
    ...
    file(GENERATE OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${bundled_target_name}.ar
      INPUT ${CMAKE_CURRENT_BINARY_DIR}/${bundled_target_name}.ar.in)

    add_custom_command(
      COMMAND /bin/sh -c "\"${CMAKE_AR}\" -M < \"${CMAKE_CURRENT_BINARY_DIR}/${bundled_target_name}.ar\""
      OUTPUT ${bundled_target_full_name}
      COMMENT "Bundling ${bundled_target_name}"
      VERBATIM)
  endif()
